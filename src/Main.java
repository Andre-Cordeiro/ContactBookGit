...
public class Main {
    ...
    public static final String NOT_REPEATED_PHONES = "All contacts have different phone numbers.";
    ...
    private static void checkRepeatedPhones(ContactBook cBook){
        if(cBook.existsRepeatedPhones())
            System.out.println(REPEATED_PHONES);
        else
            System.out.println(NOT_REPEATED_PHONES);
